 ...
 */
        const messages = [
            { role: "system", content: "kamu adalah Aru, Seorang Asisten pribadi yang di buat oleh YASSxOFC yang siap membantu kapan pun!" },
            { role: "assistant", content: `Saya Aru, asisten pribadi yang siap membantu kamu kapan pun! Apa yang bisa saya bantu hari ini?` },
